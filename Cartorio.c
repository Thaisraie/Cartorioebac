...
int registro() //funcao responsavel por cadastrar os usuários no sistema
{
	//inicio da criacao de variáveis/string
	char arquivo[40];
	char cpf[40];
	char nome[40];
	char sobrenome[40];
	char cargo[40];
	//final criacao de variáveis/string
...
{	
	...
	{
		printf("\nEssas são as informacoes do usuário");
		printf("%s", conteudo);
		printf("\n\n");
	}
...
int main()
{
	...
	for(laco=1;laco=1;)
	{
		...
		scanf("%d", &opcao); //armazenaando a escolha do usuário
